package com.jeffersonandrade.todosimple.exceptions;
...
public class GlobalExceptionHandler extends ResponseEntityExceptionHandler implements AuthenticationFailureHandler {
    ...
    public ResponseEntity<Object>handleConstraintViolationException(
        ...
        log.error("Failed to validade element: " + errorMessage, constraintViolationException);
    ...
    @ResponseStatus(HttpStatus.FORBIDDEN)
    public ResponseEntity<Object>handlerAuthorizationException(
    ...
    public void onAuthenticationFailure(
        ...
        ErrorResponse errorResponse = new ErrorResponse(status,"Email ou senha invalida!");
